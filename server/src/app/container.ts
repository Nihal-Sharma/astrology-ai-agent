...
export function createContainer(): AppContainer {
  ...
  /*
   * Provider picked per config.llm.provider/speech.*Provider
   * (default "gemini") — see their doc comments in config.ts.
   * Embeddings below are NOT branched: they stay on OpenAI
   * unconditionally.
   */
  const llm: LlmClient =
