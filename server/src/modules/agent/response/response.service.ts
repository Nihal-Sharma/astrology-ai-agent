...
export class ResponseService {
  constructor(
    ...
    /**
     * See config.llm.responseReasoningEffort's doc comment —
     * trades some of the reasoning model's "thinking" depth for
     * a faster time-to-first-token, without changing which
